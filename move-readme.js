...
fs.readFile('./11ty-site/pages/documentation.md', 'utf8', function (err,data) {
  ...
  var result = result.replace(/{{root}}/g, 'https://ngblaylock.github.io/extract-gsheet')
  var result = result.replace(/{{global.gitHubRepoURL}}/g, 'https://github.com/ngblaylock/extract-gsheet')
